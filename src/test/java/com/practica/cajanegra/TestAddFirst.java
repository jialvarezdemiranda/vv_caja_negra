...
public class TestAddFirst {
	...
	public static Stream<Arguments> data(){
		...
		SingleLinkedListImpl<String> expected2=new SingleLinkedListImpl<String>("B","A","B","C","D","E","F");
		SingleLinkedListImpl<String> expected3=new SingleLinkedListImpl<String>("N","A","B","C","D","E","F");
		SingleLinkedListImpl<String> expected4=new SingleLinkedListImpl<String>("Y","A","B","C","D","E","F");
		SingleLinkedListImpl<String> expected5=new SingleLinkedListImpl<String>("Z","A","B","C","D","E","F");
	...
	@ParameterizedTest
	@MethodSource("data")
	void testAddFirst(String elem,SingleLinkedListImpl<String> expected)
	{
		listaBase.addFirst(elem);
